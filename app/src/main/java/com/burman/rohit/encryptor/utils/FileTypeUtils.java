...
public class FileTypeUtils {
    public enum FileType {
        ENCRYPTED(R.drawable.document_lock_128,R.string.type_encrypted, "aes"),
        ...
        ARCHIVE(R.drawable.ic_zip_box, R.string.type_archive, "cab", "7z", "alz", "arj", "bzip2", "bz2", "dmg", "gzip", "gz", "jar", "lz", "lzip", "lzma", "zip", "rar", "tar", "tgz","apk");
